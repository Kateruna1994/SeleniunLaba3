...
public class RegisterAccountPage extends BasePage {
  ...
  private final By clickFieldPhone = By.xpath(
      "//div[@class='col-sm-10']/input[@id='input-telephone']");
  private final By clickPassword = By.xpath(
      "//div[@class='col-sm-10']/input[@id='input-password']");
  private final By clickBeginPassword = By.xpath(
      "//div[@class='col-sm-10']/input[@id='input-confirm']");
  ...
  private final By clickFieldEnterEmail = By.xpath(
      "//div[@class='form-group']/input[@id='input-email']");
  private final By clickFieldMyPassword = By.xpath(
      "//div[@class='form-group']/input[@id='input-password']");
